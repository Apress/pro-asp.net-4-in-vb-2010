<%@ Page Language="VB" AutoEventWireup="false" Inherits="Membership.PwdRecoverTemplate" Codebehind="PwdRecoverTemplate.aspx.vb" %>
...
<body>
   ...
   <div style="text-align: center">
      <asp:PasswordRecovery ID="PasswordTemplateCtrl"
         runat="server">
         <MailDefinition From="pwd@apress.com" Priority="High"
            Subject="Important information" />
         <UserNameTemplate>
            <span style="text-align: center">
               <h2>
                  Forgotten your Password?</h2>
         ...
         <QuestionTemplate>
            <span style="text-align: center">
               ...
               <asp:Button ID="NextButton" CommandName="Submit"
