...
Partial Class GridViewSort2
    ...
    Protected Sub gridEmployees_DataBound(
        ...
        If gridEmployees.SelectedIndex <> -1 Then
            ViewState("SelectedValue") =
                gridEmployees.SelectedValue.ToString()
        End If
    End Sub
    ...
    Protected Sub gridEmployees_SelectedIndexChanged(
        ...
        Dim selectedValue As String =
            DirectCast(ViewState("SelectedValue"), String)
    ...
    Protected Sub lstSorts_SelectedIndexChanged(
        ByVal sender As Object, ByVal e As System.EventArgs
        ) Handles lstSorts.SelectedIndexChanged
