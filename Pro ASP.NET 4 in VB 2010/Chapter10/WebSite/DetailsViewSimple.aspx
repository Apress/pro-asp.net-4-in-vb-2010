<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetailsViewSimple.aspx.vb"
    Inherits="DetailsViewSimple" %>
...
<body>
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
            BorderStyle="Double" CellPadding="4" DataKeyNames="EmployeeID"
            DataSourceID="sourceEmployees" Font-Names="Verdana" Font-Size="Small"
            ForeColor="#333333" GridLines="None" Height="50px" Width="509px"
