<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridViewTemplate.aspx.vb" Inherits="GridViewTemplate" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="gridEmployees" runat="server" CellPadding="4" DataSourceID="sourceEmployees"
            ...
            AutoGenerateColumns="False" Width="498px" BorderStyle="Groove" DataKeyNames="EmployeeID" >
            ...
            <Columns>
             <asp:TemplateField HeaderText="Employees">
                  ...
                  <small><i>
                    ...
                    Font-Names="Verdana" Font-Size="XX-Small" Height="40px" TextMode="MultiLine" Width="413px" />
                    <br /><br />
