<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridViewFormatted.aspx.vb" Inherits="GridViewFormatted" %>
    ...
    <form id="form1" runat="server">
     <div>
        <asp:SqlDataSource ID="sourceEmployees" runat="server" 
            ...
            SelectCommand="SELECT EmployeeID, FirstName, LastName, BirthDate, Title, City, Country, Notes FROM Employees">
        </asp:SqlDataSource>
