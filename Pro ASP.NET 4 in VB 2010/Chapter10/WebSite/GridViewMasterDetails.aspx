<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridViewMasterDetails.aspx.vb" Inherits="GridViewMasterDetails" %>
...
<body>
    ...
    <div>
        <asp:ObjectDataSource ID="sourceEmployees" runat="server" SelectMethod="GetEmployees"
            TypeName="DatabaseComponent.DatabaseComponent.EmployeeDB"></asp:ObjectDataSource>
        ...
        <asp:GridView ID="gridEmployees" runat="server" CellPadding="4" DataSourceID="sourceEmployees"
            Font-Names="Verdana" Font-Size="X-Small" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="EmployeeID" BorderStyle="Solid" BorderWidth="2px" >
