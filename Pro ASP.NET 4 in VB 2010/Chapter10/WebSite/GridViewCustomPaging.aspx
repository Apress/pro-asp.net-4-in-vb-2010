<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridViewCustomPaging.aspx.vb"
    Inherits="GridViewCustomPaging" %>
...
<body>
    ...
    <div>
        <asp:ObjectDataSource ID="sourceEmployees" runat="server" SelectMethod="GetEmployees"
            ...
            EnablePaging="True" SelectCountMethod="CountEmployees"></asp:ObjectDataSource>
        &nbsp; &nbsp;
