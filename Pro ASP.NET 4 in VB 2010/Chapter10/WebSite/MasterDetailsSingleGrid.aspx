<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterDetailsSingleGrid.aspx.vb" Inherits="MasterDetailsSingleGrid" %>
    ...
    <form id="form1" runat="server">
     <div>
        <asp:GridView id="gridMaster" runat="server" GridLines="None" BorderWidth="1px" BorderColor="Tan"
			...
			ForeColor="Black" DataKeyNames="CategoryID" Font-Size="X-Small" DataSourceID="sourceCategories" >
			...
			<Columns>			
				...
				<asp:TemplateField HeaderText="Products">
					...
					<ItemTemplate>
						<asp:GridView id="gridChild" runat="server" Font-Size="XX-Small" 
