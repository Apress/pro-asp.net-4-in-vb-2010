...
<%@ Register Src="Customers.ascx" TagName="MyCustomers"
   TagPrefix="uc1" %>
...
<body>
   ...
   <div>
      ...
      <table width="100%">
         <tr valign="middle" style="background-color: #00ccff">
            <td colspan="2">
         ...
         <tr valign="top">
            <td style="width: 20%">
               <asp:ConnectionsZone ID="MyConnections" runat="server"
                  BackColor="#F7F6F3" BorderColor="#CCCCCC" BorderWidth="1px"
                  ...
                  <HeaderStyle BackColor="#E2DED6" Font-Bold="True"
               ...
               <asp:CatalogZone runat="server" ID="SimpleCatalog"
                  BackColor="#F7F6F3" BorderColor="#CCCCCC" BorderWidth="1px"
                  Font-Names="Verdana" Padding="6">
                  <ZoneTemplate>
                     <asp:PageCatalogPart runat="server" ID="MyCatalog" />
                     <asp:ImportCatalogPart runat="server" ID="MyImport" />
                  </ZoneTemplate>
                  <HeaderVerbStyle Font-Bold="False" Font-Size="0.8em"
                     Font-Underline="False" ForeColor="#333333" />
            ...
            <td style="width: 60%">
               <asp:WebPartZone runat="server" ID="MainZone"
                  ...
                  <ZoneTemplate>
                     <apress:UserControlHostPart ID="TestUserControlHost" runat="server" />
                     <uc1:MyCustomers ID="MyCustomers" runat="server" />
            ...
            <td style="width: 20%">
               <asp:WebPartZone runat="server" ID="HelpZone"
                  BorderColor="#CCCCCC" Font-Names="Verdana"
                  Padding="6">
                  <ZoneTemplate>
                     <apress:CustomerNotesConsumer ID="MyNotesConsumer"
                        runat="server" />
