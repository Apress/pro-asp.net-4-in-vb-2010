<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ObjectDataSourceParameters.aspx.vb" Inherits="ObjectDataSourceParameters" %>
    ...
    <form id="form1" runat="server">
     <div>
        ...
        <asp:ListBox ID="lstEmployees" runat="server" DataSourceID="sourceEmployeesList" DataTextField="EmployeeID"
            Width="131px" AutoPostBack="True" Height="171px"></asp:ListBox>
