<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SingleValueBinding.aspx.vb" Inherits="SingleValueBinding" %>
...
<body>
   ...
   <div>
        ...
        <asp:HyperLink runat="server" NavigateUrl='<%# LogoPath.Value %>'
          Font-Bold="True" Text="Show logo" ID="Hyperlink1"/>
        <br />
        ...
        <br />
        <b>Random Number: </b><asp:Label ID="EBLabel" runat="server" Text="<%$ RandomNumber: 1,6 %>" />
    </div>
    </form>
</body>
</html>
