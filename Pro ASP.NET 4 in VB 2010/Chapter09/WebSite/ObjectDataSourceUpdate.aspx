<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ObjectDataSourceUpdate.aspx.vb" Inherits="ObjectDataSourceUpdate" %>
...
<body>
   ...
   <div>
        <asp:ObjectDataSource ID="sourceEmployees" runat="server" InsertMethod="InsertEmployee"
            ...
            UpdateMethod="UpdateEmployee" DataObjectTypeName="DatabaseComponent.EmployeeDetails">
