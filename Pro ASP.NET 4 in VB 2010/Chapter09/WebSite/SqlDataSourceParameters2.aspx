<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SqlDataSourceParameters2.aspx.vb" Inherits="SqlDataSourceParameters2" %>
...
<body>
    ...
    <div>
            <asp:SqlDataSource ID="sourceEmployees" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:Northwind %>" SelectCommand="SELECT EmployeeID, FirstName, LastName, Title, City FROM Employees WHERE City=@City">
            <SelectParameters>    
