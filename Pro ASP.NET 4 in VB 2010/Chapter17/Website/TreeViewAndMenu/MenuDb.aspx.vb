...
Partial Class TreeViewAndMenu_MenuDb
    ...
    Protected Sub Page_Load(
        ...
        If Not Page.IsPostBack Then
            ...
            For Each row As DataRow In ds.Tables("Categories").Rows
                ...
                Dim itemCategory As New MenuItem(
                ...
                For Each childRow As DataRow In childRows
                    Dim itemProduct As New MenuItem(
        ...
        End If
    End Sub
    Protected Sub Menu1_MenuItemClick1(
        ...
        ElseIf Menu1.SelectedItem.Depth = 1 Then
